...
class DeckServerImpl : public DeckServerPrivate<DeckServerImpl, TcpServer, TcpSocket> {
  friend DeckServerPrivate<DeckServerImpl, TcpServer, TcpSocket>;
  using DeckServerPrivate<DeckServerImpl, TcpServer, TcpSocket>::DeckServerPrivate;
